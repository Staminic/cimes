...
<div class="item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<div class="hero">
        ...
        <div class="overlay"></div>
				...
				<div class="container d-flex flex-column">
					...
					<div class="hero-slogan h1 m-0">
						<p class="small">Référence</p>
					</div>
  ...
  <div class="container">
    ...
    <div itemprop="articleBody" class="row reference">
			<div class="col-lg-4">
				<div class="index card text-white bg-primary mb-3">
					<div class="card-body">
						{index}
					</div>
				</div>
			</div>
			<div class="content col-lg-8 col-xl-7 offset-xl-1">
